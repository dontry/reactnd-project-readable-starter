...
// export const ROOT_URL = "https://react-blogpost-server-2018.herokuapp.com";
...
export function votePostById(id, option) {
...
export function updateCommentById(id, comment) {
  return ax.put(`${ROOT_URL}/comments/${encodeURIComponent(id)}`, {
    ...comment
  });
}
